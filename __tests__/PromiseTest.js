...
describe("Promise", function () {
    ...
    it("resolve promise", function () {
        ...
        var promise2 = new Promise_1.Promise(function (resolve, reject) {
            resolve2 = resolve;
        });
        resolve1(promise2);
        promise1.then(function (value) {
    ...
    it("Promise resolve", function () {
        ...
        Promise_1.Promise.resolve(value1).then(function (value) {
            valueCheck = value + value2;
        });
        expect(valueCheck).toBe(value1 + value2);
    });
    it("Promise reject, and then", function () {
        var value1 = 234, value2 = 3523, valueCheck;
        Promise_1.Promise.reject(value1).catch(function (value) {
            return value + value2;
        }).then(function (value) {
            valueCheck = value;
        });
    ...
    it("Resolve All success", function () {
        ...
        var promise = Promise_1.Promise.all([promise1, promise2, value1]);
        resolve1(value2);
        resolve2(value3);
    ...
    it("Promise all reject", function () {
        ...
        Promise_1.Promise.all([Promise_1.Promise.resolve(12), 15, Promise_1.Promise.reject(error)]).catch(function (err) {
            reason = err;
        });
